...
import Chatting from "components/Match/Chat/Chat";
          ...
          */}
          <Box className="nav-link-container">
            <Grid container spacing={2}>
              <Grid item xs={1} />
              <Grid item xs={2}>
                <NavLink to="MatchPredict" className={"nav-link"}>
                  승부예측
                </NavLink>
              </Grid>
              <Grid item xs={2}>
                <NavLink to="LineUp" className={"nav-link"}>
                  라인업
                </NavLink>
              </Grid>
              <Grid item xs={2}>
              ...
              <Grid item xs={2}>
                <NavLink to="PlayerEvaluate" className={"nav-link"}>
                  선수평가
                </NavLink>
              </Grid>
              <Grid item xs={2}>
