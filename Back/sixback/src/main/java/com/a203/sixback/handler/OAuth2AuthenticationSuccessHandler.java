...
import static com.a203.sixback.auth.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static com.a203.sixback.auth.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        RoleType roleType = hasAuthority(authorities, RoleType.ROLE_ADMIN.getValue()) ? RoleType.ROLE_ADMIN : RoleType.ROLE_USER;
